  ...
  return (
    <div>
      ...
      <div className="border-2 shadow-lg">
        <div className=" max-w-[1500px] mx-auto md:p-8 lg::p-8 navbar bg-base-100">
          ...
          <div className="navbar-end">
            <div className="form-control w-full hidden md:block lg:block">
              <input
                type="text"
                placeholder="Search"
        ...
        <div className="form-control w-[80%] m-auto mb-4  md:hidden lg:hidden">
          <input
            type="text"
            placeholder="Search"
            className="input input-bordered rounded-3xl  md:w-auto"
          />
        </div>
      </div>
    </div>
